package io.itjun.examples.core.day02;
...
public class OperateDemo2 {
    public static void main(String[] args) {
         ...
         * false; | : 两边只要有一个为true，结果为true。 只有两边都有false，结果为false。
         */

        /*
         * ^ : 异或；就是和|有点不一样。当true ^ true = false; true ^ true = false; true ^ false =
         * true; false ^ true = true; false ^ false = false; ^ : 两边相同结果是false。
         * 两边不同结果是true。
         *
         */
        ...
        // 8 = 11 - 3;
        /*
         * n = n + m;//如果n和m的值非常大，容易超出int范围。 m = n - m; n = n - m;
         */
